...
class WC_Form_Handler {
	...
	public static function save_account_details() {
		...
		$account_first_name = ! empty( $_POST['billing_first_name'] ) ? wc_clean( $_POST['account_first_name'] ) : '';
		$account_last_name  = ! empty( $_POST['billing_last_name'] ) ? wc_clean( $_POST['account_last_name'] ) : '';
