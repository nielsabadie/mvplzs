...
<?php if ( $has_orders ) : ?>
	...
	<table id="cardMesAchats" class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
		<thead>
			<tr>
		...
		<tbody>
			<?php foreach ( $customer_orders->orders as $customer_order ) :
				...
				<tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $order->get_status() ); ?> order">
					...
					<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-order-number" data-title="Photo">
						<a href="<?php echo esc_url( $order->get_view_order_url() ); ?>">
									<?php 
										...
										//echo $product_obj->get_image();
											echo $product_obj->get_image(64);
										}?>
						</a>
					</td>
					
					
					<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-order-number" data-title="Titre">
						<a href="<?php echo esc_url( $order->get_view_order_url() ); ?>">
									<?php 
										// Get a list of all items that belong to the order
										$products = $order->get_items();
