...
<div id="infos-bancaires" class="my-account-details">
	...
	<div class="row" style="margin-top: 20px;">
		<div class="col-sm-12 no-padding-left">
			<button type="button" class="btn btn-default .btn-sm btn-second" data-toggle="modal" data-target="#modif-infos-bank"><?php echo $iban ? "Modifier" : "Ajouter"?> mes informations bancaire</button>
		</div>
...
<div class="container-fluid">
	<div class="row" style="padding-bottom: 16px; padding-top: 20px;">
		<div class="col-sm-12 no-padding-left">
			...
			<a id="unsubscribe-link" class="btn btn-default .btn-sm btn-second" href="infos-compte/desinscription" title="Me désinscrire">
