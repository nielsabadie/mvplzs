	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                ...
                <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="name" id="reg_firstname" placeholder="Chuck" value="<?php echo ( ! empty( $_POST['fname'] ) ) ? esc_attr( $_POST['fname'] ) : ''; ?>" />
			</p>
