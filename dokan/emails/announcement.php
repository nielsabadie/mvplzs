                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                                        <tr>
                                            <td style="border-radius: 3px; padding-bottom: 40px text-align: center;" class="button-td">
                                                <a <?php echo sprintf( __( 'href="%s"', 'dokan' ), $data['announcement_url'] ) ?> style="background: #56b537; border: 15px solid #56b537; font-family: sans-serif; font-size: 13px; line-height: 110%; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
