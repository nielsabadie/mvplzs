                ...
                <tbody>
                     ...
                     <tr>
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
							...
							Un nouveau produit à été ajouté sur <a href="<?php echo $data['site_url'] ?>" ><?php echo $data['site_name'] ?></a>.
                        </td>
                    </tr>
                    <tr>
                    	<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <ul>
                            	<li>
                            		<?php _e( 'Title :', 'dokan-lite' ); ?> <?php printf( '<a href="%s">%s</a>', $data['product_link'], $data['product-title']  ); ?>
                            	</li> 
                            	<li>
                            		<?php _e( 'Price :', 'dokan-lite' ); ?> <?php echo wc_price( $data['price'] ); ?>
                            	</li>
                            	<li>
                            		<?php _e( 'Vendor :', 'dokan-lite' ); ?> <?php printf( '<a href="%s">%s</a>', $data['seller_url'], $data['seller-name']  ); ?>
                            	</li>
                            	<li>
                            		<?php _e( 'Category :', 'dokan-lite' ); ?> <?php echo $data['category'] ?>
                            	</li> 
                            </ul>
