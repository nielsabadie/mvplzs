        ...
        <?php if ( $sellers['users'] ) : ?>
            <ul class="dokan-seller-wrap">
                ...
                foreach ( $sellers['users'] as $seller ) {
					...
					$user_meta = get_user_meta ($seller->ID);
                    ?>
                                ...
                                <div class="store-info" style="background-image: url( '<?php echo is_array( $banner_url ) ? $banner_url[0] : $banner_url; ?>');">
                                    <div class="store-data-container">
                                        ...
                                        <div class="store-data">
                                            ...
                                            <?php if ( $user_meta['billing_city'][0] ): ?>
                                            	<p style="display: inline-block" class="store-address"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo htmlspecialchars( $user_meta['billing_postcode'][0] . ' ' . $user_meta['billing_city'][0] )?></p>
                                            <?php endif ?>
