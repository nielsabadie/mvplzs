            ...
            <?php foreach ( $notices as $notice ): ?>
                ...
                <li>
                    ...
                    <div class="dokan-dashboard-announce-date dokan-right <?php echo ( $notice->status == 'unread' ) ? 'dokan-dashboard-announce-unread' : 'dokan-dashboard-announce-read';
								...
								?>">
                        <div style="display: block" class="announce-day"><?php echo strftime( '%e', strtotime( $notice->post_date ) ); ?></div>
                        <div class="announce-month"><?php echo strftime( '%B', strtotime( $notice->post_date ) ); ?></div>
                        <div class="announce-year"><?php echo strftime( '%Y', strtotime( $notice->post_date ) ); ?></div>
                    </div>
