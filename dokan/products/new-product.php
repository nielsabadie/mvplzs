                                    ...
                                    <div class="row formRow">
                                        ...
                                        <div class="col col-sm-8 left">
                                            ...
                                            <div id="formShippingWeight" class="dokan-form-group col col-sm-12">
												...
												<select name="product_weight" class="product_cat dokan-form-control dokan-select2" id="sel1">
                                                    <option class="dokan-form-group-2" <? //$product->get_weight() === '0.25' ? 'checked' : '' ?>  value="0.25" id="value-250-g">< 250g</option>
                                                    <option class="dokan-form-group-2" <? //$product->get_weight() === '0.50' ? 'checked' : '' ?>  value="0.5" id="value-500-g">< 500g</option>
                                                    <option class="dokan-form-group-2" <? //$product->get_weight() === '1' ? 'checked' : '' ?>  value="1" id="value-1-kg">< 1kg</option>
                                                    <option class="dokan-form-group-2" <?// $product->get_weight() === '2' ? 'checked' : '' ?>  value="2" id="value-2-kg">< 2kg</option>
                                                    <option class="dokan-form-group-2" <? //$product->get_weight() === '5' ? 'checked' : '' ?>  value="5" id="value-5-kg">< 5kg</option>
                                                    <option class="dokan-form-group-2" <? //$product->get_weight() === '10' ? 'checked' : '' ?>  value="10" id="value-10-kg">< 10kg</option>
                                                    <option class="dokan-form-group-2" <? //$product->get_weight() === '30' ? 'checked' : '' ?>  value="30" id="value-30-kg">< 30kg max</option>
											    </select>	
                                            </div>
