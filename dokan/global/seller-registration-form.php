...
<div class="show_if_seller"<?php echo $role_style; ?>>
    ...
    <!--<div class="split-row form-row-wide">
        <p class="form-row form-group">
            ...
            <input type="text" class="input-text form-control" name="fname" id="first-name" value="<?php if ( ! empty( $postdata['f'] ) ) echo esc_attr($postdata['fname']); ?>" required="required" />
        </p>
...
<p class="form-row form-group user-role">
    ...
    <label class="radio">
        <input type="radio" name="role" value="seller"<?php checked( $role, 'seller' ); ?> checked="true">
        <?php _e( 'I am a vendor', 'dokan-lite' ); ?> 
    </label>
    -->

    <input id="reg_role" name="role" type="hidden" value="seller">
