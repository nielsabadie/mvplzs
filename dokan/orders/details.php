    ...
    <div class="dokan-w4 dokan-order-right-content">
        <div class="dokan-clearfix">
            <div class="" style="width:100%">
                <div class="dokan-panel dokan-panel-default">
                    ...
                    <div class="dokan-panel-body general-details">
                        <ul class="list-unstyled order-status">
                            ...
                            <li>
                                <span><?php _e( 'Shipping number', 'dokan-lite' ); ?></span>
                                <?php
                                    if(get_post_meta($order_id, 'shipping-track', true))
                                        echo get_post_meta($order_id, 'shipping-track', true);
                                    else
                                        echo "Numéro de suivi non renseigné";
                                ?>
                            </li>
                            <li>
                                <span><?php _e( 'Shipping status', 'dokan-lite' ); ?></span>
                                <?php
                                    if(get_post_meta($order_id, 'shipping-track', true))
                                        echo $statusColissimo[$stateShipping];
                                    else
                                        echo "Numéro de suivi non renseigné";
                                ?>
                            </li>
              ...
              <div class="clearfix dokan-form-group" style="margin-top: 10px; padding: 0; padding-bottom: 10px; border:solid 1px #3ab5e7">
                                
                                <div style="background-color: #3ab5e7; padding: 10px; padding-bottom: 0; width:100%">
                                	<h5 style="color: #ffffff"><i class="fa fa-truck fa-lg"></i> Indiquez le numéro de suivi</h5>
								</div>
                                
                                <div style="background-color: #fafafa; padding: 10px; width:100%">
...
-->
										<div class="dokan-form-group">
											...
											<input type="text" name="tracking_number" id="tracking_number" class="dokan-form-control" value="<?= get_post_meta($order_id, 'shipping-track', true) ?>">
										</div>
<!--
										<div class="dokan-form-group">
...
-->
										...
										<div class="dokan-form-group">
											...
											<button type="button" class="btn btn-default" id="dokan-cancel-tracking-note"><?php _e( '<i class="fa fa-arrow-circle-o-up"></i>', 'dokan-lite' );?></button>
										</div>
									</form>
								</div>
                            </div>
